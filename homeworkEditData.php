<main>
    <?php
        ...
        if($type == "teacher"){
            $updatedid = $_GET['id'];
            $select_sql = "SELECT * FROM homework WHERE id = '{$updatedid}'";
            $result = mysqli_query($conn, $select_sql);
            $row = $result->fetch_assoc();
    ...
    <section id="lesson">
        ...
        <div class="">
           <div class="login-form roundborder">
                ...
                <form  action="homeworkAfterEditData.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row col-12 nopadd">
                        ...
                        <div class="col-12 col-md-9 nopadd leftmargin"><input type="text" class="form-control" placeholder="Homework Title" name="title" value="<?=$row['title']?>" required></div>
                    </div>
                    <div class="form-group row col-12 nopadd">
