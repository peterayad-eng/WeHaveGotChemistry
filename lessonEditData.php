    ...
    <section id="lesson">
        ...
        <div class="">
           <div class="login-form roundborder">
                ...
                <form  action="lessonAfterEditData.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row col-12 nopadd">
                        ...
                        <div class="col-12 col-md-9 nopadd leftmargin"><input type="text" class="form-control" placeholder="Lesson Label" name="caption" value="<?=$row['caption']?>" required></div>
                    </div>
                    <div class="form-group row col-12 nopadd">
                        <div class="col-6 col-md-2 labelCenter"><label>Video URL</label></div>
                        <div class="col-12 col-md-9 nopadd leftmargin"><input type="text" class="form-control" placeholder="URL" name="url" value="<?=$row['url']?>" required></div>
                    </div>
