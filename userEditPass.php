...
<html>	
	...
	<?php
		...
		$connec = new con();
		$conn = $connec->connect();
        $select_sql = "SELECT user FROM users WHERE id = '{$id}'";
        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form roundborder">
                    ...
                    <form  action="userResetPass.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?=$id?>"/>
                        <div class="form-group">
                            <label>User Name</label>
                            <input type="text" class="form-control" placeholder="User Name" value="<?=$row['user']?>" disabled>
                        </div>
                        <div class="form-group">
