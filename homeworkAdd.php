    ...
    <section id="lesson">
        ...
        <div class="">
           <div class="login-form roundborder">
                ...
                <form  action="homeworkAfterAdd.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group row col-12 nopadd">
                        <div class="col-2 labelCenter"><label>Title</label></div>
                        <div class="col-12 col-md-9 nopadd leftmargin"><input type="text" class="form-control" placeholder="Homework Title" name="title" required></div>
                    </div>
                    <div class="form-group row col-12 nopadd">
                    ...
                    <div class="stat-widget-four form-group row col-12 topmargin">
                        ...
                        <div class="stat-content col-9 leftmargin nopadd">
                            <div class="text-left dib row col-12">
